...
<header class="main-header">
                            ...
                            <nav class="main-menu navbar-expand-md navbar-light clearfix">
                                <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li class="dropdown"><a href="service-2.php" style="padding-top: 19px;">Services</a>
                                            <ul>
                                        ...
                                        <li class="dropdown"><a href="team.php" style="padding-top: 19px;">Pages</a>
                                            <ul>
                                                <li class="dropdown"><a href="team.php">Directors</a>
                                                    <ul>
                                                ...
                                                <li><a href="index.php">Credit Cards</a></li>
                                                <li><a href="faq.php">General FAQ’s</a></li>
                                            </ul>
                                        </li> 
                                        <li><a href="contact.php" style="padding-top: 19px;">Contact</a></li> 
                                    </ul>
                                </div>
                            </nav>
                            <div 
                            class="menu-right-content ml_70">
                              <form action="/login-register/myadmin/login.php">  <a href="/login-register/myadmin/login.php" class="theme-btn btn-two mr_20">Login</a></form>
                    ...
                    <div class="outer-box">
                        ...
                        <div class="menu-area">
                            ...
                            <div class="menu-right-content ml_70">
                                <a href="/myadmin/login.php" class="theme-btn btn-two mr_20">Login</a>
                                <a href="contact.php" class="theme-btn btn-one">Open Account</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                ...
                <div class="contact-info">
                    <h4>Contact Info</h4>
                    <ul>
                        <li>JanSeva Urban Co-operation Bank, Itwari</li>
                        <li><a href="tel:+8801682648101">+88 01682648101</a></li>
                        <li><a href="mailto:info@example.com">JanSeva@gmail.com</a></li>
                    </ul>
                </div>
        ...
        <!-- team-section -->
        <section class="team-section pt_120 pb_75">
            <div class="auto-container">
                            ...
                            <div class="inner-box">
                                <div class="image-box">
                                    ...
                                    <ul class="social-links clearfix">
                                        <li><a href="team.php"><i class="fab fa-facebook-f"></i></a></li>
                                        <li><a href="team.php"><i class="fab fa-twitter"></i></a></li>
                                        <li><a href="team.php"><i class="fab fa-instagram"></i></a></li>
                                    </ul>
                                </div>
                                <div class="lower-content">
                                    <h3><a href="team-details.php">Wade Warren</a></h3>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <h3><a href="team-details.php">Bessie Cooper</a></h3>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <h3><a href="team-details.php">Devon Lane</a></h3>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <h3><a href="team-details.php">Robert Fox</a></h3>
                                    <span class="designation">Head of Finance</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <h3><a href="team-details.php">Darlene Robertson</a></h3>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <h3><a href="team-details.php">Albert Flores</a></h3>
                                    <span class="designation">Chief Marketer</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <footer class="main-footer">
            ...
            <div class="footer-bottom centred">
                <div class="auto-container">
                    <div class="copyright"><p>Copyright 2024 by <a href="index.php">JanSeva Urban Co-operation Bank</a>. All Right Reserved.</p></div>
                </div>
            </div>
        </footer>
        <!-- main-footer end -->
